import 'package:baby_name/Class/Baby_Name_Class.dart';
import 'package:baby_name/View/Add_Name/Add_Name_View.dart';
import 'package:baby_name/View/search_name/search_name_view.dart';
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return ListTile(
                  ...
                  subtitle: Row(
                    children: <Widget>[
                      Flexible(child: Text("meaning : ${searchResults[index].meaning} \n")),
